function [corners, Ixx, Iyy, Ixy, Iyx, CURL, DIV] = imcurlVpts(method, I, MinQuality)
...
[metricMatrix, Ixx, Iyy, Ixy, Iyx, CURL, DIV] = cornerMetric(method, I, filter2D);
...
function [metric, Ixx, Iyy, Ixy, Iyx, CURL, DIV] = cornerMetric(method, I, filter2D)
